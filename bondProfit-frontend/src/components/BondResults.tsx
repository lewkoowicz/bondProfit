...
interface BondResponse {
    totalSavings: number;
    totalSavingsWithoutBonds: number;
    difference: number;
    bondDetails: string[];
}
...
const BondResults = () => {
    ...
    const { results } = location.state as { results: BondResponse };
                    ...
                    <div className="p-2 sm:p-4">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center stats shadow">
                            ...
                            <div className="stat">
                                ...
                                <div className="stat-value text-lg">{results.totalSavingsWithoutBonds}</div>
                            </div>
                            <div className="stat">
